          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="form-group">
                      <label for="InputEmail1">LOGIN ID</label>
                      <input type="text" class="form-control" name="InputEmail" id="InputEmail" aria-describedby="emailHelp" placeholder="ENTER LOGIN ID" required>
          ...
          <div class="col-lg-6">
                <div class="card" style="padding: 6%;">
                  ...
                  <i class="fas fa-address-card fa-10x"></i>
                        ...
                        echo '<a href="#" onclick="current()" class="btn btn-success">Go to PROFILE</a> ';
                        }                      
                        ?>                             
                        </div>
                      </center>
