  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="form-group">
          <textarea class="form-control" id="message" rows="3" placeholder="You can enter any personalized alert for the teacher over here !!!"></textarea>
       </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary"  onclick="set2()">Send Alert</button>
      </div>
      </form>
    </div>
  </div>
...
var semester;
var name;
    function setEventId(t_id,sub,sem,t_name){
