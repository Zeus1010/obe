...
$sub_query3="INSERT INTO `dash_data`(`t_id`, `sub`, `sem`, `year`, `branch`, `co_spec`, `po_spec`, `co_po_map`, `marks_map`) 
                  VALUES ('$t_id','$sub','$sem','$year','$branch_hod',0,0,0,0)";
      ...
      <div class="container-fluid">
        ...
        <div class='col-10'>
          <div class="container-fluid">
              ...
              <div class="row">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_allo" style="margin-left:1.3% ">Add Allocation</button>
              </div>
          </div>
        </div>
        </div>
