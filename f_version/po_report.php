...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 1%">
      ...
      <form method="post" action="" enctype="multipart/form-data" style="margin-left: 2.5%"> 
      <p style="font-size:large;">Please enter the details for Program Outcome Attainment Table:</p>
        <div class="form-row" style="margin-top: 2%">
          ...
          <div class="form-group col-md-3">
            <input type="number" class="form-control" name="thresh_per" placeholder="Threshold % Marks">
          </div>
          </div>
          <div class="form-row">
          <div class="form-group col-md-3" style="margin-right: 1%">
            <input type="number" class="form-control" name="r1" placeholder="Threshold-1 in %(lower)">
          </div>
          <div class="form-group col-md-3" style="margin-right: 1%">
            <input type="number" class="form-control" name="r2" placeholder="Threshold-2 in %">
          </div>
          <div class="form-group col-md-3" style="margin-right: 1%">
            <input type="number" class="form-control" name="r3" placeholder="Threshold-3 in %">
          </div>
